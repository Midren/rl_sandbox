...
"""
Taken from YangtaoWANG95/TokenCut/unsupervised_saliency_detection/dino.py
...
if __name__ == "__main__":
    model = ViTFeat('/dino/dino_vitbase8_pretrain/dino_vitbase8_pretrain.pth', 64, 'base', 'k', patch_size=8)
    img = torch.FloatTensor(4, 3, 64, 64)
    # Forward pass in the model
    feat = model(img)
    print (feat[0].shape)
